  ...
  return (
    <>
      ...
      {profile && (
        ...
        <div className=' justify-center  p-8 sm:flex sm:space-x-6 '>
        ...
        <div className='flex flex-col space-y-4'>
          <div>
            ...
            <span className='text-sm dark:text-gray-400'>{profile.bio}</span>
          </div>
          <div className='space-y-1'>
            ...
            <span className='flex items-center space-x-2'>
              ...
              <span className='dark:text-gray-400'>{profile.phone}</span>
            </span>
          </div>
          </div>
                  </div>
                  <h1 className='text-2xl p-5'>Account Preference</h1>
                  <hr />
